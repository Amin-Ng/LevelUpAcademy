        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    XPRequired = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    UserId = table.Column<string>(type: "TEXT", nullable: true),
                    XP_Gained = table.Column<int>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserBadgeBadgeId = table.Column<int>(type: "INTEGER", nullable: true),
                    UserBadgeUserId = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserBadges_UserBadges_UserBadgeUserId_UserBadgeBadgeId",
                        columns: x => new { x.UserBadgeUserId, x.UserBadgeBadgeId },
                        principalTable: "UserBadges",
                        principalColumns: new[] { "UserId", "BadgeId" });
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserBadges_UserBadgeUserId_UserBadgeBadgeId",
                table: "UserBadges",
                columns: new[] { "UserBadgeUserId", "UserBadgeBadgeId" });
